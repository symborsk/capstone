...
This file is used to read in data from the MPL115A1 barometer sensor
over the GPIO pins of a Raspberry Pi 3

The code here relies on the sample code provided from this github repo

https://github.com/sparkfun/Barometric_Pressure_Sensor_Breakout-MPL115A1

Originally created by Jim Lindblom - jim at sparkfun.com

Copyright

Licensed under Creative Commons ShareAlike 4.0 International

If we ever meet Jim we'll owe him a beer as it is also under beerware
*/
